 ...
 * 
 * $Id: demo_util.h 1972 2013-05-14 20:20:48Z achaloyan $
 */
...
mrcp_message_t* demo_recognize_message_create(mrcp_session_t *session, mrcp_channel_t *channel, const apt_dir_layout_t *dir_layout, const char* message_body);
