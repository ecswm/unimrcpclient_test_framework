 ...
 * 
 * $Id: demo_util.c 1972 2013-05-14 20:20:48Z achaloyan $
 */
...
mrcp_message_t* demo_recognize_message_create(mrcp_session_t *session, mrcp_channel_t *channel, const apt_dir_layout_t *dir_layout, const char* text)
{
	//const char text[] = "file:///y:/service/0/GM1/dg2.grxml\n";
	...
	if(mrcp_message) {
		...
		if(recog_header) {
			...
			/* disable timer to test continuous recognition*/
