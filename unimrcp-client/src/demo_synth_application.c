 ...
 * 
 * $Id: demo_synth_application.c 1957 2013-04-12 02:12:51Z achaloyan $
 */
...
static apt_bool_t synth_application_run(demo_application_t *demo_application, const char *profile, void* clrSession);
